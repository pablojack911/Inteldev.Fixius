...
using Inteldev.Fixius.Vistas.Stock;
using System;
...
namespace Inteldev.Fixius.VistasModelo
{
    public class VMIngreso:VistaModeloBase<Ingreso>
    {
        ...
        public VMIngreso(Ingreso dto)
            : base(dto)
        {
            this.SetPresentador<FacturaDeCompra>("PresentadorFacturas", dto.Facturas);
        }

        # region Facturas
        public IPresentadorGrilla<Ingreso,FacturaDeCompra,VistaFacturaDeCompra> PresentadorFacturas
        {
            get { return (IPresentadorGrilla<Ingreso,FacturaDeCompra,VistaFacturaDeCompra>)GetValue(PresentadorFacturasProperty); }
