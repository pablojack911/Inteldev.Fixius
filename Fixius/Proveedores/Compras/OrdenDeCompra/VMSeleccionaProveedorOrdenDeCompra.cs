...
namespace Inteldev.Fixius.Proveedores.Compras.OrdenDeCompra
{
	public class VMSeleccionaProveedorOrdenDeCompra : VistaModeloBaseDialogo<ProveedorNuevo>
	{
		...
		public IPresentadorMiniBusca<Fixius.Servicios.DTO.Proveedores.Proveedor> PresentadorMiniBuscaProveedor
		{
            get { return (IPresentadorMiniBusca<Fixius.Servicios.DTO.Proveedores.Proveedor>)GetValue(PresentadorMiniBuscaProveedorProperty); }
		...
		public static readonly DependencyProperty PresentadorMiniBuscaProveedorProperty =
            DependencyProperty.Register("PresentadorMiniBuscaProveedor", typeof(IPresentadorMiniBusca<Fixius.Servicios.DTO.Proveedores.Proveedor>), typeof(VMSeleccionaProveedorOrdenDeCompra));
