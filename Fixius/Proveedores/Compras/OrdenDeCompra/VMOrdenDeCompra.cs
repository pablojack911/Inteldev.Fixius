...
{
    public class VMOrdenDeCompra : VistaModeloBase<Servicios.DTO.Proveedores.OrdenDeCompra>
    {
        ...
        public static readonly DependencyProperty PresentadorDepositoProperty =
            DependencyProperty.Register("PresentadorDeposito", typeof(IPresentadorMiniBusca<Core.DTO.Stock.Deposito>), typeof(VMOrdenDeCompra));

        public IPresentadorMiniBusca<CondicionDePagoProveedor> PresentadorCondicionDePago
        {
            get { return (IPresentadorMiniBusca<CondicionDePagoProveedor>)GetValue(PresentadorCondicionDePagoProperty); }
        ...
        public static readonly DependencyProperty PresentadorCondicionDePagoProperty =
            DependencyProperty.Register("PresentadorCondicionDePago", typeof(IPresentadorMiniBusca<CondicionDePagoProveedor>), typeof(VMOrdenDeCompra));
        ...
        public IPresentadorGrilla<Servicios.DTO.Proveedores.OrdenDeCompra, Observacion, Inteldev.Core.Presentacion.Controles.ItemObservacion> PresentadorObservaciones
        {
            get { return (IPresentadorGrilla<Servicios.DTO.Proveedores.OrdenDeCompra, Observacion, Inteldev.Core.Presentacion.Controles.ItemObservacion>)GetValue(PresentadorObservacionesProperty); }
            set { SetValue(PresentadorObservacionesProperty, value); }
        }

        // Using a DependencyProperty as the backing store for PresentadorObservaciones.  This enables animation, styling, binding, etc...
        public static readonly DependencyProperty PresentadorObservacionesProperty =
            DependencyProperty.Register("PresentadorObservaciones", typeof(IPresentadorGrilla<Servicios.DTO.Proveedores.OrdenDeCompra, Observacion, Inteldev.Core.Presentacion.Controles.ItemObservacion>), typeof(VMOrdenDeCompra));
        ...
        private string suma = "";
        public VMOrdenDeCompra(Servicios.DTO.Proveedores.OrdenDeCompra DTO)
            : base(DTO)
        {
            ...
            //this.SetPresentador<ObservacionProveedor>("PresentadorObservaciones", );
        }
